...
Students should consult the latest COVID-19 testing and health protocol requirements for on-campus courses. Continuously updated requirements can be found on the USC COVID-19 resource center website at https://coronavirus.usc.edu/students/
...
| Sep 7 & 9          | Model                  |                                       | - HW 3                                 |
+--------------------+------------------------+---------------------------------------+----------------------------------------+
| Week 4\            | - Effect Decomposition | - SB ch 4.6, 5.1--5.3                 | - Exercise: Effect decomposition       |
| Sep 14 & 16        | - Random Coefficient   |                                       | - HW 4                                 |
|                    | Model                  |                                       |                                        |
|                    | - Cross-level          |                                       |                                        |
|                    | Interactions           |                                       |                                        |
+--------------------+------------------------+---------------------------------------+----------------------------------------+
| Week 5\            | - Model Estimation     | - SB ch 4.7, 6                        | - Exercise: Maximum likelihood         |
| Sep 21 & 23        | - Model Testing        |                                       | estimation (MLE)                       |
|                    | - Reporting Results    |                                       | - HW 5                                 |
+--------------------+------------------------+---------------------------------------+----------------------------------------+
| Week 6\            | - Model Assumptions    | - SB ch 10                            | - Exercise: TBD                        |
...
+--------------------+------------------------+---------------------------------------+----------------------------------------+
| Week 9\            | - Models for           | - [Hoffman (2014) ch 8][11]           | - Exercise: Autoregressive             |
| Oct 19 & 21        | Longitudinal Data II   |                                       | and lagged effects                     |
|                    |                        |                                       | - HW 8                                 |
|                    |                        |                                       | - Prospectus (due Oct 25)              |
+--------------------+------------------------+---------------------------------------+----------------------------------------+
| Week 10\           | Individual meeting     |                                       |                                        |
| Oct 26 & 28        | on final research      |                                       |                                        |
|                    | project                |                                       |                                        |
+--------------------+------------------------+---------------------------------------+----------------------------------------+
